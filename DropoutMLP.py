...
def test_mlp(rng, initial_learning_rate=.1, initial_momentum = 0.5, L1_reg=0.00, L2_reg=0.0001, n_epochs=1000,
             dataset='/home/chris/data/mnist/mnist.pkl.gz', batch_size=20, n_hidden=500, max_neuron_l2_input=15,
...
test_mlp(rng, initial_learning_rate = 0.1, initial_momentum = 0.5, L1_reg=0.00, L2_reg=0.001,
          n_epochs=500, dataset='/home/dan/PycharmProjects/BackPropagation/mnist.pkl.gz',
